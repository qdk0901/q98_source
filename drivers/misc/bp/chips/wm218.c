...
struct bp_operate bp_wm218_ops = {
	.name			= "wm218",
	.bp_id			= BP_ID_WM218,
	.bp_bus			= BP_BUS_TYPE_USB,		
	.bp_pid			= 0,	
	.bp_vid			= 0,	
	.bp_power		= BP_UNKNOW_DATA,
	.bp_en			= BP_UNKNOW_DATA,
	...
	.bp_uart_en		= BP_UNKNOW_DATA,
	.bp_usb_en		= BP_UNKNOW_DATA,
...
static int __init bp_wm218_init(void)
{
...
static void __exit bp_wm218_exit(void)
{
	//struct bp_operate *ops = bp_get_ops();
...
subsys_initcall(bp_wm218_init);
module_exit(bp_wm218_exit);
