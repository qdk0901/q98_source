...
static void anx6345_early_suspend(struct early_suspend *h)
{
	...
	gpio_direction_output(anx6345->pdata->bl_en_pin, !anx6345->pdata->bl_en_val);
	gpio_direction_output(anx6345->pdata->dvdd33_en_pin,!anx6345->pdata->dvdd33_en_val);
	gpio_direction_output(anx6345->pdata->dvdd18_en_pin,!anx6345->pdata->dvdd18_en_val);
	gpio_direction_output(anx6345->pdata->edp_rst_pin, 0);
}
...
static void anx6345_late_resume(struct early_suspend *h)
{
	...
	gpio_direction_output(anx6345->pdata->edp_rst_pin,0);
	msleep(50);
	gpio_direction_output(anx6345->pdata->edp_rst_pin,1);
