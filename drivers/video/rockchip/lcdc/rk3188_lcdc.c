...
#define LCDC0_DCLK_DRV LCDC_DCLK_12MA
#define LCDC0_DATA_DRV LCDC_DATA_4MA//LCDC_DATA_8MA
#define LCDC1_DCLK_DRV LCDC_DCLK_12MA
#define LCDC1_DATA_DRV LCDC_DATA_4MA//LCDC_DATA_8MA
...
static int rk3188_lcdc_init(struct rk_lcdc_device_driver *dev_drv)
{
	...
	if(lcdc_dev->id == 0)
	{
		...
		#endif
        v = LCDC0_DCLK_DRV;        
        writel_relaxed(v,RK30_GRF_BASE + GRF_IO_CON3);     
        v = LCDC0_DATA_DRV;        
        writel_relaxed(v,RK30_GRF_BASE + GRF_IO_CON4);
	}
	...
	if(lcdc_dev->id == 1) //iomux for lcdc1
	{
		...
		#endif
        v = LCDC1_DCLK_DRV;        
        writel_relaxed(v,RK30_GRF_BASE + GRF_IO_CON1);     
        v = LCDC1_DATA_DRV;        
        writel_relaxed(v,RK30_GRF_BASE + GRF_IO_CON2);
