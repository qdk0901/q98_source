			       ...
			       const struct usb_device_id *id)
{
	...
	if (type->attach) {
		...
		if (((le16_to_cpu(dev->descriptor.idVendor) == 0x1782 ) && (le16_to_cpu(dev->descriptor.idProduct) == 0x0002) && (bp_id == 12))
			...
			|| ((le16_to_cpu(dev->descriptor.idVendor) == 0x19d2) && (le16_to_cpu(dev->descriptor.idProduct) == 0xffeb)) //WM218
			|| ((le16_to_cpu(dev->descriptor.idVendor) == 0x05c6) && (le16_to_cpu(dev->descriptor.idProduct) == 0x6000)) //QM800/QM725/ME200
			|| ((le16_to_cpu(dev->descriptor.idVendor) == 0x05c6) && (le16_to_cpu(dev->descriptor.idProduct) == 0x910E)) //MT815
		){
			BP_USB =1;
